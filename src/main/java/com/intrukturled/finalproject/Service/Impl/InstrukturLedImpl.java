...
public class InstrukturLedImpl implements InstruktureLedService {
    ...
    public InstrukturLed addInstrukturLed(InstrukturLedRequest instrukturLedRequest) {
        Trainer trainer = trainerService.getTrainerById(String.valueOf(instrukturLedRequest.getTrainerId()));
        Participant participant = participantService.getParticipantById(String.valueOf(instrukturLedRequest.getParticipantId()));
        Questions questions = questionsService.getQuestionsById(String.valueOf(instrukturLedRequest.getQuestionsId()));
